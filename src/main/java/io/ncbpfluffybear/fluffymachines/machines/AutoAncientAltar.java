...
public class AutoAncientAltar extends SlimefunItem implements EnergyNetComponent {
    ...
    public AutoAncientAltar(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        new BlockMenuPreset(getId(), "&5自动古代祭坛") {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                ...
                menu.replaceExistingItem(7, new CustomItemStack(Material.ENCHANTING_TABLE, "&c合成一次",
                    "", "&e> 点击合成一次配方")
                );
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(2, new CustomItemStack(new ItemStack(Material.ENCHANTING_TABLE), "&e配方",
                "", "&b按配方放置物品", "&4仅限古代祭坛配方"
            ),
