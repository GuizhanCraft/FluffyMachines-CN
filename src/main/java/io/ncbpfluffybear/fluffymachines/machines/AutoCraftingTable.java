...
public class AutoCraftingTable extends SlimefunItem implements EnergyNetComponent {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        for (int i : keyBorder) {
            preset.addItem(i, new CustomItemStack(new ItemStack(Material.YELLOW_STAINED_GLASS_PANE), "&e&l要合成的物品"),
                (p, slot, item, action) -> false);
        }

        preset.addItem(statusSlot, new CustomItemStack(new ItemStack(Material.YELLOW_STAINED_GLASS_PANE), "&e&l空闲的"),
            (p, slot, item, action) -> false);
