            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                ...
                if (holo == null || holo.equals("true")) {
                    menu.replaceExistingItem(HOLOGRAM_TOGGLE_SLOT,
                        new CustomItemStack(Material.QUARTZ_SLAB, "&3切换全息投影 &a(打开)"));
                } else {
                    menu.replaceExistingItem(HOLOGRAM_TOGGLE_SLOT,
                        new CustomItemStack(Material.QUARTZ_SLAB, "&3切换全息投影 &c(关闭)"));
                }
                ...
                menu.replaceExistingItem(INSERT_ALL_SLOT,
                    new CustomItemStack(Material.CYAN_STAINED_GLASS_PANE, "&b放入所有",
                        "&7> 点击此处将所有可用物品放入蓬松桶"));
                ...
                menu.replaceExistingItem(EXTRACT_ALL_SLOT,
                    new CustomItemStack(Material.ORANGE_STAINED_GLASS_PANE, "&6取出所有",
                        "&7> 点击此处取出所有物品"));
